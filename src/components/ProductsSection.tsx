...
const industries = [
  {
    ...
    description: "Fenster-, Tür- und Fassadenprofile, Dichtungen, Kantenprofile und Abdeckleisten für den Hochbau.",
    icon: (
  ...
  {
    name: "Elektrobranche",
    description: "Isolationsprofile, Kabelkanäle und Schutzprofile für elektrische Installationen und Geräte.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
  ...
  },
  {
    ...
    description: "Reflektorprofile, Leitplankenelemente und Markierungsprofile für die Verkehrssicherheit.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
  ...
  {
    name: "Sport & Freizeit",
    description: "Spezialprofile für Sport- und Freizeitgeräte, Spielplatzausrüstung und Outdoor-Anwendungen.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
  ...
  {
    name: "Fahrzeugbau",
    description: "Dichtprofile, Kantenschutz und Zierleisten für die Automobil- und Fahrzeugindustrie.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
  ...
  },
  {
    ...
    description: "Lebensmittelkonforme Profile und Dichtungen nach den strengsten Hygienevorschriften.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10 md:px-16 lg:px-20">
        ...
        <div className="reveal mt-12 flex items-start gap-4 rounded-lg bg-warm-white p-6">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-steel/10">
            <svg className="h-5 w-5 text-steel" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-relaxed text-text-muted">
              Wir verarbeiten eine breite Palette thermoplastischer Kunststoffe.
              Die Werkstoffwahl erfolgt individuell nach Ihren technischen Anforderungen,

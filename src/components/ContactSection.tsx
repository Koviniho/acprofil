            ...
            <div className="reveal mt-10 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+41629653878" className="mt-1 block text-sm text-text-muted transition-colors hover:text-brass">
                    +41 (0) 62 965 38 78
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:ac-profil@bluewin.ch" className="mt-1 block text-sm text-text-muted transition-colors hover:text-brass">
              ...
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-navy">
                  <svg className="h-5 w-5 text-brass" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/company/acprofil" target="_blank" rel="noopener noreferrer" className="mt-1 block text-sm text-text-muted transition-colors hover:text-brass">
                    AC PROFIL AG
                  </a>
                </div>
              </div>
            ...
            <div className="reveal rounded-2xl border border-border bg-white p-8 shadow-xl shadow-black/5 lg:p-10">
              ...
              <form className="mt-8 space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-navy" htmlFor="firma">
                      Firma
                    </label>
                    <input
                      id="firma"
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-navy" htmlFor="telefon">
                      Telefon
                    </label>
                    <input
                      id="telefon"
                ...
                <div>
                  <label className="block text-sm font-medium text-navy" htmlFor="nachricht">
                    Nachricht *
                  </label>
                  <textarea
                    id="nachricht"

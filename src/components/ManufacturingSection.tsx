                    ...
                    <div>
                        ...
                        <div className="reveal mt-8 space-y-5">
                            <p className="text-base leading-[1.8] text-white/60">
                                Bei der Extrusion werden feste bis dickflüssige, durch Kälte
                                härtbare Massen unter Zugabe von Temperatur mit Druck kontinuierlich
                                durch eine formgebende Öffnung gepresst.
                            </p>
                            <p className="text-base leading-[1.8] text-white/60">
                                Der Begriff stammt vom lateinischen{' '}
                                <em className="text-white/80">&laquo;extrudere&raquo;</em> &mdash;
                                hinausstossen oder -treiben. Dieses Verfahren ermöglicht die
                                Herstellung von Profilen gemäss dem Querschnitt des Werkzeugs in
                                beliebiger Länge.
                            </p>
                        </div>
                        ...
                        <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-8 backdrop-blur-sm lg:p-10">
                            ...
                            <div className="mt-8 space-y-4">
                                {[
                                    {
                                        step: 'Granulat',
                                        desc: 'Thermoplastisches Rohmaterial',
                                        w: '100%',
                                    },
                                    {
                                        step: 'Erhitzen',
                                        desc: 'Temperaturzufuhr & Plastifizierung',
                                        w: '85%',
                                    },
                                    {
                                        step: 'Pressen',
                                        desc: 'Druck durch formgebende Düse',
                                        w: '68%',
                                    },

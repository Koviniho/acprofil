                        ...
                        <div className="reveal mt-10 flex items-start gap-4 rounded-lg border border-border bg-warm-white p-5">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-sm leading-relaxed text-text-muted">
                                    Qualitätsmanagement zertifiziert seit 1995. Kompromisslose
                    ...
                    <div className="lg:col-span-7">
                        <div className="reveal space-y-6">
                            <p className="text-base leading-[1.8] text-text-muted">
                                ...
                                Kunststoffprofile aus thermoplastischen Werkstoffen. Wir bedienen
                                Kunden in der{' '}
                                <strong className="font-medium text-text">
                                    Bau- und baunahen Industrie
                                </strong>
                                , der{' '}
                                <strong className="font-medium text-text">Elektrobranche</strong>,
                                im <strong className="font-medium text-text">Verkehrswesen</strong>,
                                Sport, Freizeit, Fahrzeugbau und der Lebensmittelindustrie.
                            </p>
                            <p className="text-base leading-[1.8] text-text-muted">
                                Wir bearbeiten die vielfältigen Anforderungen unserer Kunden
                                individuell und pflegen einen ständigen Dialog &mdash; von der
                                ersten Idee bis zur Realisierung. Unser Ziel sind Lösungen, die
                                technisch einwandfrei, wirtschaftlich sinnvoll und praxisgerecht
                                sind.
                            </p>
                        </div>
                        ...
                        <div className="reveal mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
                            {[
                                ...
                                <div
                                    key={item.title}
                                    className="group rounded-lg p-4 transition-all duration-300 hover:bg-warm-white"
                                >

          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/[0.06] text-white/40 transition-all duration-300 hover:bg-brass/20 hover:text-brass"
                aria-label="LinkedIn"
              >
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4">
              <li className="flex items-start gap-3">
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-brass/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li>
                <a href="tel:+41629653878" className="flex items-center gap-3 text-sm text-white/35 transition-colors duration-200 hover:text-white/70">
                  <svg className="h-4 w-4 shrink-0 text-brass/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div>
            ...
            <div className="mt-5 rounded-lg border border-white/[0.06] bg-white/[0.03] p-5">
              <div className="flex items-center gap-3">
                <svg className="h-8 w-8 text-brass/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
